...
/*
    ...
    mk_bindings("./mpir", "gmp.h", "./mpir", "gmp_bindings.rs",
      false, true);
    mk_bindings("./mpir", "gmpxx.h", "./mpir", "gmpxx_bindings.rs",
      false, true);
    mk_bindings("./mpir", "mpir.h", "./mpir", "mpir_bindings.rs",
      false, true);
*/
  }

//  println!("cargo:rustc-link-search=native={}", "./mpir/lib");
  println!("cargo:rustc-link-search={}", "./mpir/lib");
  println!("cargo:rustc-link-lib=dylib={}", "libgmp-10");
//  println!("cargo:rustc-link-lib=dylib={}", "libgmpxx-4");
